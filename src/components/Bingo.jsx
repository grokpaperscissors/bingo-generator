...
const suggestions = [
  ...
  "Successfully validated form data as part of the Bot games challenge", 
  "Joined the Bengaluru Chapter in the Pathfinder Community",
  "Spotted someone with a Pathfinder laptop sticker", "Shared your Bot Games certificate on LinkedIn",
